            ...
            child: Container(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    Image.network(
                      "https://i.redd.it/1s0j5e4fhws01.png",
                      height: 64,
                    ),
                    Padding(
                    ...
                    Text(
                      (isEntrando)
                          ? "Faça login para criar sua lista de skins."
                          : "Faça seu cadastro para começar a criar sua lista de skins.",
                      textAlign: TextAlign.center,
                    ),
                    TextFormField(
  ...
  esqueciMinhaSenha() {
    ...
    showDialog(
      ...
      builder: (context) {
        ...
        return AlertDialog(
          title: const Text("Confirme o email para redefinição de senha"),
          ...
          actions: [
            TextButton(
              onPressed: () {
                authService
                    .redefinicaoDeSenha(email: redefinicaoSenhaController.text)
                    .then((String? erro) {
                  if (erro == null) {
                    showSnackBar(
                        context: context,
